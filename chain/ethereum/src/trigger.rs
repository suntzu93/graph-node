...
pub enum MappingTrigger {
    Log {
        ...
        log: Arc<Log>,
        params: Vec<graph::abi::DecodedParam>,
    ...
    Call {
        ...
        inputs: Vec<graph::abi::DecodedParam>,
        outputs: Vec<graph::abi::DecodedParam>,
    },
    Block {
        block: Arc<LightEthereumBlock>,
    },
    ...
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        enum MappingTriggerWithoutBlock {
            Log {
                ...
                _log: Arc<Log>,
                _params: Vec<graph::abi::DecodedParam>,
            },
            Call {
                _transaction: Arc<Transaction>,
                _call: Arc<EthereumCall>,
                _inputs: Vec<graph::abi::DecodedParam>,
                _outputs: Vec<graph::abi::DecodedParam>,
            },
            Block,
        }
...
pub struct EthereumEventData {
    ...
    pub params: Vec<graph::abi::DecodedParam>,
}
...
pub struct EthereumCallData {
    ...
    pub block: EthereumBlockData,
    pub transaction: EthereumTransactionData,
    pub inputs: Vec<graph::abi::DecodedParam>,
    pub outputs: Vec<graph::abi::DecodedParam>,
}
